...
class OtherOwnerProfilePage extends StatefulWidget {
  final Landowner info;

  const OtherOwnerProfilePage({
    super.key,
    required this.info,
  });

  @override
  State<OtherOwnerProfilePage> createState() =>
      _OtherOwnerProfilePageState();
}

class _OtherOwnerProfilePageState extends State<OtherOwnerProfilePage> {
  @override
